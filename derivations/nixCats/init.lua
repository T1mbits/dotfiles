...
--   non_nix_value = true,
-- } -- commented out cause I don't ever see myself not using nix with this config
...
-- require("myLuaConf.non_nix_download") -- idk this keeps on breaking everything and I dont plan on not using nix so whatever
